...
BASE_CONFIG_PATH = '/root/autodl-tmp/DT-Pose-main/config/mmfi/pose_config-Copy1.yaml'
TEMP_CONFIG_PATH = '/root/autodl-tmp/DT-Pose-main/config/mmfi/temp_config_run-Copy1.yaml'
# 设置 5 个随机种子
SEEDS = [0, 1, 2, 3, 4]
...
def main():
    ...
    for seed in SEEDS:
        ...
        # 3. 组装运行命令
        cmd = ["python", "-W", "ignore", "train_pose-Copy1.py", "--config_file", TEMP_CONFIG_PATH]
