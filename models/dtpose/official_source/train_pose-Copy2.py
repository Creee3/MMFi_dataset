...
if __name__ == '__main__':
    ...
    parser.add_argument("--config_file", type=str, help="Configuration YAML file", default='config/mmfi/pose_config-Copy2.yaml')
    ...
    log_dir = os.path.join('logs', config['dataset_name'], config['setting'], 'pose_logs', config['experiment_name'])
